...
| **Results from Race data Analysis.txt** | Text Report | Full statistical output, including detailed stint tables and coefficient calculations. | [`Results from Race data Analysis.txt`](https://github.com/tchara96/F1_Race_Analysis/blob/main/02_F1_Post_Race_Analysis/Results%20from%20Race%20data%20Analysis.txt)|
